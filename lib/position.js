...
module.exports = function position(elem) {
  ...
  if ((0, _css.default)(elem, "position") === "fixed") {
    ...
    if (offsetParent && offsetParent !== elem && offsetParent.nodeType === 1) {
      ...
      parentOffset.top += parseFloat((0, _css.default)(offsetParent, "borderTopWidth")) || 0 - (0, _scrollTop.default)(offsetParent) || 0;
      parentOffset.left += parseFloat((0, _css.default)(offsetParent, "borderLeftWidth")) || 0 - (0, _scrollLeft.default)(offsetParent) || 0;
    }
